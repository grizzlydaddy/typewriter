...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/typograph.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  _createClass(Typograph, [{
    ...
    value: function setSequences() {
      ...
      this.sequences = Array.from(document.querySelectorAll('.typeMe'), function (e) {
        var text = Array.from(_this4.text || e.dataset.type || e.textContent);
        e.innerText = null;
        return {
          target: e,
...
//# sourceMappingURL=../maps/typograph.js.map