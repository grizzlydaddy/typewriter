...
var global = __webpack_require__(3);
var hide = __webpack_require__(7);
var Iterators = __webpack_require__(1);
...
module.exports = !__webpack_require__(4) && !__webpack_require__(28)(function () {
    ...
    value: function mistype(sequence) {
      ...
      if (trueChar && !/\s/.test(trueChar)) {
        ...
        if (this.keyboard.join().indexOf(trueChar) >= 0) {
          ...
          var isBorderLetter = !letterPosition || letterPosition + 1 === keyboardLine.length;
          var wrongChar = isBorderLetter ? keyboardLine[letterPosition + (letterPosition ? -1 : 1)] : keyboardLine[letterPosition + (Math.round(Math.random()) ? 1 : -1)];
