...
var getIterFn = __webpack_require__(16);
...
module.exports = !__webpack_require__(3) && !__webpack_require__(25)(function () {
...
var Typograph = function () {
  ...
  (0, _createClass3.default)(Typograph, [{
    ...
    value: function blinkCursor(sequence) {
      if (sequence.cursor) {
        ...
        if (this.synchroniseCursors) {
          ...
          try {
            for (var _iterator = (0, _getIterator3.default)(document.querySelectorAll('.typewriter-cursor')), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              var e = _step.value;
    ...
    value: function erase(params) {
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(this.sequences), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function setSequences() {
      ...
      this.sequences = (0, _from2.default)(document.querySelectorAll(this.target), function (e) {
        var text = (0, _from2.default)(_this3.text || e.dataset.typeit || e.textContent);
        e.innerText = '';
        return {
          target: e,
          textNode: e.appendChild(document.createTextNode('')),
          cursor: _this3.setCursor(e),
          text: text
        };
      });
    }
        ...
        if (sequence.text.length) {
          if (mistyped) {
            _this4.backspace({
              ...
              speed: 500,
              callback: function callback() {
                _this4.mistyped = false;
                _this4.typeLetters(sequence, speed, true);
              }
            });
          } else {
            _this4.typeLetters(sequence, speed);
          }
        } else {
          sequence.end = true;
          _this4.blinkCursor(sequence);
          if (_this4.callback && _this4.callback instanceof Function && !_this4.retyped && _this4.sequences.every(function (e) {
            return e.end;
          })) {
            _this4.callback.call(_this4);
          }
        }
      });
    }
    ...
    value: function type() {
      ...
      try {
        for (var _iterator3 = (0, _getIterator3.default)(this.sequences), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
